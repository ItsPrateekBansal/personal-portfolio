        ...
        >
          <div>
            <Badge className="mb-4 px-3 py-1 text-sm bg-primary/10 text-primary border-primary/20 hover:bg-primary/20">
              CS Grad Student at San Jose State University
            </Badge>
            ...
            <p className="text-xl text-muted-foreground md:text-2xl max-w-md leading-relaxed">
              Building scalable distributed systems and leading cross-functional initiatives for enhanced system
              reliability.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Button variant="outline" size="lg" asChild className="group bg-transparent">
              <a
                href="https://drive.google.com/file/d/1qdlmPRHU9rAGt64bXfjIAGFLW9QRMYJo/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className="relative group">
            ...
            <div className="relative h-72 w-72 sm:h-80 sm:w-80 overflow-hidden rounded-full border-2 border-background">
              <img
                ...
                alt="Prateek Bansal - Software Engineer"
