...
const experiences: ExperienceItem[] = [
  {
    ...
    description: [
      "Driving cross-functional initiatives to enhance system reliability, including distributed tracing, fault tolerance, and proactive alerting mechanisms.",
      "Leading end-to-end design and development of scalable backend systems with a focus on performance, resilience, and observability.",
    ],
    skills: [
      "Java",
      "Spring Boot",
  ...
  },
  {
    ...
    description: [
      "Engineered a backend service to monitor and track downstream API requests, built a reconciliation system to ensure data consistency.",
  ...
  },
  {
    ...
    description: [
      "Built a Chrome extension for NiFi job operations, saving around $700 per day in operational costs.",
    ...
    skills: ["JavaScript", "Chrome Extensions", "Cassandra", "Time-Series Data"],
  },
]
